...
class AllProdsPresenter<V: AllProdsView, I: AllProdsInteractorInterface> @Inject constructor(var interactor: I): BasePresenter<V>(),
    AllProdsPresenterCardModelInterface<V> {
