...
class AddProdInteractor @Inject constructor(var retrofit: Retrofit, var currentUserClass: CurrentUserClassInterface, val repository: RepositoryInterface): AddProdInteractorInterface, UserCardInteractor() {
