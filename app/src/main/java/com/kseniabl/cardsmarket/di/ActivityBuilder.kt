...
abstract class ActivityBuilder {
    ...
    @ContributesAndroidInjector(modules = [(MainActivityModule::class), (AddProdFragmentModule::class), (AllOffersFragmentModule::class), (SettingsFragmentModule::class), (ShowItemFragmentModule::class), (AllProdsFragmentModule::class), (ExecutorFragmentModule::class), (AddTasksFragmentModule::class), (DraftFragmentModule::class)])
